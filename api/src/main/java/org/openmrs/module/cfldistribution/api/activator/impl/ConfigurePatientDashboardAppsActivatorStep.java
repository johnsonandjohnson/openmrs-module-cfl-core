...
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.APPOINTMENTSCHEDULINGUI_TAB_EXT;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.ATTACHMENTS_EXT;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.ATTACHMENTS_OVERALL_ACTION_EXT;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.CFL_LATESTOBSFORCONCEPTLIS_APP;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.CFL_PATIENT_DASHBOARD_IMPROVEMENTS_APP;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.CFL_RELATIONSHIPS_APP;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.COREAPPS_ACTIVE_VISITS_APP;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.COREAPPS_CONDITIONLIST_APP;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.COREAPPS_CREATE_RETROSPECTIVE_VISIT_EXT;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.COREAPPS_CREATE_VISIT_EXT;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.COREAPPS_DATA_MANAGEMENT_APP;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.COREAPPS_LATEST_OBS_FOR_CONCEPT_LIST_APP;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.COREAPPS_MARK_PATIENT_DECEASED_EXT;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.COREAPPS_MERGE_VISITS_EXT;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.COREAPPS_MOST_RECENT_VITALS_APP;
import static org.openmrs.module.cfldistribution.api.util.PatientDashboardAppsConstants.COREAPPS_OBS_ACROSS_ENCOUNTERS_APP;
