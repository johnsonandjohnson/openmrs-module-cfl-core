...
public class HtmlFormsMetadata extends VersionedMetadataBundle {
    ...
    protected void installNewVersion() throws Exception {
        ...
        final List<String> htmlforms =
                Arrays.asList("cfldistribution:htmlforms/cfl-HIV.xml", "cfldistribution:htmlforms/cfl-check-in.xml",
                        "cfldistribution:htmlforms/cfl-visit-note.xml", "cfldistribution:htmlforms/cfl-medicine-refill.xml",
                        "cfldistribution:htmlforms/cfl-sputum-visit-note.xml",
                        "cfldistribution:htmlforms/encounters-form.xml", "cfldistribution:htmlforms/cfl-hiv-enrollment.xml",
