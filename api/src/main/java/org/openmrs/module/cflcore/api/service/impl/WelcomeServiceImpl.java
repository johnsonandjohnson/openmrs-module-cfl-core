...
public class WelcomeServiceImpl implements WelcomeService {
  ...
  public void sendWelcomeMessages(Person person) {
    ...
    final List<WelcomeMessageSender> senders =
        Context.getRegisteredComponents(WelcomeMessageSender.class);
      ...
      try {
        ...
        LOGGER.error(
            MessageFormat.format(
                "Failed to execute WelcomeMessageSender: {0}.", sender.getClass().getName()),
            ex);
      }
    }
  }
