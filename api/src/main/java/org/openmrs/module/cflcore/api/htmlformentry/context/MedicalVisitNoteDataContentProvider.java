...
public class MedicalVisitNoteDataContentProvider implements VelocityContextContentProvider {
  ...
  public void populateContext(FormEntrySession formEntrySession, VelocityContext velocityContext) {
    formEntrySession.addToVelocityContext(
        "medicalVisitNoteFunctions",
        new MedicalVisitNoteFunctions(Context.getService(MedicalVisitNoteService.class)));
  }
}
