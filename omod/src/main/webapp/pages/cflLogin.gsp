                                ...
                                <div id="log-in-wrapper">
                                    ...
                                    <% if(!selectLocation) { %>
                                        <p class="left username-block">
                                            ...
                                            <input class="form-control form-control-sm form-control-lg form-control-md credential-input" id="username" type="text" name="username"/>
                                        </p>
                                        <p class="left">
                                            <label for="password" class="credential-label">
                                                ${ ui.message("referenceapplication.login.password") }:
                                            </label>
                                            <input class="form-control form-control-sm form-control-lg form-control-md credential-input" id="password" type="password" name="password"/>
                                        </p>
                                    <% } %>
                                    ...
                                    <% } %>
                                        <input id="loginButton" class="btn ${ ui.message(selectLocation ? "confirm" : "btn-success") } login-input" type="submit"
